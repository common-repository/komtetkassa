...
= 1.3.0 = 
* Добавлен ещё один sdk class

= 1.2.0 = 
* Отображение тела чека в отчётах
* формат номера телефона под формат кассы
* СНО под новую версию sdk

= 1.0.1 = 
* Проверена работа плагина с последней актуальной версией WordPress
* Изменено наименование плагина в readme.txt, komtetkassa.php
